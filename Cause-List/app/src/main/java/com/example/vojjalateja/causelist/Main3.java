...
public class Main3 extends AppCompatActivity {
    ...
    String ini="http://hc.tap.nic.in/Hcdbs/search.do",ga="information";
        ...
        if(connectionDetector.isConnectingToInternet()==false)
        {
            ...
            class MyJavaScriptInterface {
                ...
                public void showHTML(String html)
                {
                    ...
                    i.putExtra("comstring1","GP FOR INFORMATION AND TECHNOLOGY (TG)");
                    i.putExtra("comstring2","GP FOR INFORMATION AND TECHNOLOGY");
