...
public class Main2 extends AppCompatActivity {
    ...
    String ini="http://hc.tap.nic.in/Hcdbs/search.do",ga="finance";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(connectionDetector.isConnectingToInternet()==false)
        {
            ...
            class MyJavaScriptInterface {
                ...
                {
                    Main2.mainhtmlcontents=html;
                    Intent i=new Intent(context,GetInfo.class);
                    i.putExtra("comstring1","GP FOR FINANCE and PLANNING (TG)");
                    i.putExtra("comstring2","GP FOR FINANCE and PLANNING");
